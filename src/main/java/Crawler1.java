...
public class Crawler1 extends WebCrawler {
    ...
    private final static SolrClient solr = new ConcurrentUpdateSolrClient.Builder(Config.SOLR_URL_1).build();
